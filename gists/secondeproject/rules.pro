:-module(rules).
:-import(list).
:-export([delete/3,delmax/3,delnmax/3,delnmin/3,delmin/3,filterdelnmin/3,filterdelnmax/3,maxmax/3,minmin/3,nmax/3,nmin/3,mx/3,mn/3,filternmax/3,filternmin/3]). %elhamdolellah
:-op(400,yfx,///).
