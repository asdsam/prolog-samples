...
maximum(Combinations,X,O,Max///N):-listofvalues(Combinations,Xlist,Olist,L),mx(L,0,Max),num(Max,L,N).
minimum(Combinations,X,O,Min///N):-listofvalues(Combinations,Xlist,Olist,L),mn(L,10,Min),num(Min,L,N).
